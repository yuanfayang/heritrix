...
<html>
    ...
    %>
        <meta http-equiv=Refresh content="<%=refreshInterval%> URL=do_show_log.jsp?<%=crawler.getQueryString()+"&"+log.getQueryString(log.getCurrentLog(),log.getMode())%>">
    <%
    }
    %>
    
    <form method="get" action="do_show_log.jsp" name="frmLogs">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td align="left" valign="top" width="160">
                            	...
                            	%>
	                                <a href="do_show_log.jsp?<%=crawler.getQueryString()+"&"+log.getQueryString(logtype,log.getMode())%>" <%=currentLog==logtype?"style='text-decoration: none; color: #000000'":""%>><%=logtype.getFilename()%></a><br>
                            	<%
                            		}
                            	%>
                        ...
                        <tr>
                            ...
                            <td align="left" valign="top" width="150">
                               	<% for(Log.Mode modeType : Log.Mode.values()){ %>
	                               	<a href="do_show_log.jsp?<%=crawler.getQueryString()+"&"+log.getQueryString(log.getCurrentLog(),modeType)%>" <%=mode==modeType?"style='text-decoration: none; color: #000000'":""%>><%=modeType.getDescription()%></a><br>
	                            <% } %>
