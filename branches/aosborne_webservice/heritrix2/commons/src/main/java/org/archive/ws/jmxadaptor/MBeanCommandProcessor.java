...
public class MBeanCommandProcessor extends JmxCommandProcessor {
    ...
    private Element createMBeanElement(Document document,
            ObjectName objectName, HttpInputStream in) throws JMException {
            ...
            if (attributes != null) {
                ...
                for (int i = 0; i < attributes.length; i++) {
                    ...
                    attribute.setAttribute("description", attributes[i]
                            .getDescription());
                    attribute.setAttribute("strinit", String
                            .valueOf(CommandProcessorUtil
                                    .canCreateParameterValue(attributes[i]
                                            .getType())));
                    ...
                    try {
                        ...
                        if (attributeValue != null) {
                            ...
                            if (attributeValue instanceof java.util.Collection) {
                                attribute.setAttribute("aggregation",
                                        "collection");
                            }
                ...
                while (keys.hasNext()) {
                    root.appendChild((Element) sortedAttributes
                            .get(keys.next()));
                }
            }
        }
            ...
            if (operations != null) {
                for (int i = 0; i < operations.length; i++) {
                    ...
                    operation.setAttribute("description", operations[i]
                            .getDescription());
                    operation.setAttribute("return", operations[i]
                            .getReturnType());
                    ...
                    addParameters(operation, document, operations[i]
                            .getSignature());
        ...
        if (HttpUtil.booleanVariableValue(in, "notifications", true)) {
            ...
            if (notifications != null) {
                for (int i = 0; i < notifications.length; i++) {
                    Element notification = document
                            .createElement("Notification");
                    notification.setAttribute("name", notifications[i]
                            .getName());
    ...
    protected void addParameters(Element node, Document document,
        ...
        for (int j = 0; j < parameters.length; j++) {
            ...
            parameter.setAttribute("strinit", String
                    .valueOf(CommandProcessorUtil
