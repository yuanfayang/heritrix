...
public class HtmlFormCredential extends Credential {
    ...
    protected HtmlFormCredential(String realmPattern, String loginURI,
        String method, String cookie)
    {
        super(realmPattern, "Credential that has all necessary" +
        ...
        Type t = addElementToDefinition(new SimpleType("loginuri",
            ...
            " these credentials too.", loginURI));
        t.setOverrideable(true);
        t.setExpertSetting(true);
 
        String [] allowedValues = {"POST", "GET"};
        ...
        t = addElementToDefinition(new SimpleType("cookie-name",
            ...
            " authentication attempt.  To aid debugging only.", cookie));
        t.setOverrideable(true);
        t.setExpertSetting(true);
    }
}
