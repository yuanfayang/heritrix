 ...
 * constraints with level {@link Level#SEVERE}will throw an
 * {@link InvalidAttributeValueException}. The ValueErrorHandler will recieve a
 * notification for all failed checks with level equal or greater than the error
 * reporting level.
 * 
