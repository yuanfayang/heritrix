 ...
 * $Header$
 */
package org.archive.crawler2.framework;


import java.util.concurrent.atomic.AtomicLong;

import org.archive.crawler2.deciderules.DecideResult;
import org.archive.crawler2.deciderules.DecideRuleSequence;
import org.archive.state.Key;
import org.archive.state.KeyManager;
import org.archive.state.StateProcessor;
 ...
 * @author pjack
 *
 * @param <T>    a type of URI particular to the type of process
 */
public abstract class Processor<T extends ProcessorURI>
implements StateProcessor<T,Void,InterruptedException> {
     ...
     */
    protected abstract boolean shouldProcess(T uri);
     ...
     * @throws InterruptedException   if the thread is interrupted
     */
    protected abstract void innerProcess(T uri) 
     ...
     * @throws InterruptedException   if the thread is interrupted
     */
    protected void innerRejectProcess(T uri) 
    throws InterruptedException {        
    }
