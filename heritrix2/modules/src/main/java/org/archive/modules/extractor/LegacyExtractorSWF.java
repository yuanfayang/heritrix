 ...
 * Heritrix
 *
 * $Id: ExtractorSWF.java 5397 2007-08-14 21:54:52Z paul_jack $
 *
 ...
 */
public class LegacyExtractorSWF extends ContentExtractor {

    private static final long serialVersionUID = 3L;

    private static Logger logger =
        Logger.getLogger(LegacyExtractorSWF.class.getName());
    ...
    protected boolean innerExtract(ProcessorURI curi) {
        ...
        try {
            ...
            // alist(s).
            CrawlUriSWFAction curiAction = new CrawlUriSWFAction(uriErrors, curi);
    ...
    static {
        KeyManager.addKeys(LegacyExtractorSWF.class);
    }
    ...
    extends SWFActionsImpl {
        ...
        throws IOException {
            ...
            if (url.startsWith(JSSTRING)) {
                linkCount += ExtractorJS.considerStrings(uriErrors, curi, url, false);
            } else {
