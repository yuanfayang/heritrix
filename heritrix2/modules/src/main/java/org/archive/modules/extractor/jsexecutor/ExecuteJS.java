 ...
 * renderer and parser</a>. It has the capability of JavaScript execution,
 * and extract new links generated by JavaScript code.
 * @author Ping Wang
 *
 */
public class ExecuteJS extends Processor implements Initializable, Finishable{
    ...
    protected void innerProcess(ProcessorURI uri) {
        ...
        // Retrieve contents of current uri and all script resources
     ...
     * @param uri uri of current HTML document
     * @param contents contents of current HTML document and resources.
     * @return
     */
    ...
    /**
     * Retrieve contents of current HTML document and script resources on which
     * the HTML document depends. 
     * @param uri uri of current HTML document
     * @param fetchCache
     * @return
     */
     ...
     * @param uri
     * @param document
     * @param handleUris new uris which have been discovered.
     */
    ...
    final public static String ONMOUSEOVER_REG_EXPR = 
    	"//*[@" + "onmouseover" + "]";
    
    final public static String ONMOUSEOUT_REG_EXPR = 
    	"//*[@" + "onmouseout" + "]";
            ...
            if (eventsToSim.get(i).equalsIgnoreCase("onclick")) {
                ...
                if (nodeList != null && 
                    ...
                    for (int j = 0; j < listSize; ++ j) {
                        curDocument = parse(uri, contents);
                        nodeList = 
...
/*  Document getDocument(ProcessorURI uri, HashMap<String, String> contents) {
     ...
     * @param handledUris new uris which have been discovered.
     */
