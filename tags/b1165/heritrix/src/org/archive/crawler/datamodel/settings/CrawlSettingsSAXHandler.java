...
import org.archive.crawler.datamodel.CrawlConfiguration;
...
public class CrawlSettingsSAXHandler extends DefaultHandler {
	private CrawlConfiguration configuration;
	 ...
	 * 
	 */
	public CrawlSettingsSAXHandler(CrawlConfiguration configuration) {
		super();
	...
	public void endElement(String uri, String localName, String qName)
		...
		if (qName.equals("setting")) {
			...
			configuration.put(field, buffer.toString().trim());
			currentSetting = null;
	...
	public void startElement(
		...
		if (qName.equals("setting")) {
			...
			configuration.setComment(attributes.getValue("comment"));
		}
