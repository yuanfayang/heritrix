 ...
 * <p>This class was copied from the bdb je 2.0 jmx examples.
 */
...
public class JEMBeanHelper {
    ...
    static final String OP_ENV_STAT_STR = "getEnvironmentStatsToString";
    static final String OP_LOCK_STAT = "getLockStats";
    static final String OP_LOCK_STAT_STR = "getLockStatsToString";
    ...
    private static final MBeanOperationInfo OP_ENV_STAT_STR_INFO = 
        new MBeanOperationInfo(OP_ENV_STAT_STR,
                               "Get environment statistics.",
                               statParams,
                               "java.lang.String",
                               MBeanOperationInfo.INFO);
    ...
    private static final MBeanOperationInfo OP_LOCK_STAT_STR_INFO = 
        new MBeanOperationInfo(OP_LOCK_STAT_STR,
                               "Get locking statistics.",
                               statParams,
                               "java.lang.String",
                               MBeanOperationInfo.INFO);
     ...
     */
    public JEMBeanHelper(EnvironmentConfig config,
            File environmentHome, boolean canConfigure) {
    ...
    public List getOperationList(Environment targetEnv) {
        ...
        if (targetEnv != null) {
            ...
            operationList.add(OP_ENV_STAT_STR_INFO);
            operationList.add(OP_LOCK_STAT_INFO);
            operationList.add(OP_LOCK_STAT_STR_INFO);
    ...
    public Object invoke(Environment targetEnv,
        ...
        try {
            if (targetEnv != null) {
                ...
                } else if (actionName.equals(OP_ENV_STAT_STR)) {
                ...
                } else if (actionName.equals(OP_LOCK_STAT_STR)) {
                    return targetEnv.getLockStats(getStatsConfig(params)).toString();
