...
public class SeedFileIteratorTest extends TestCase {
   ...
   public void testGeneral() throws IOException {
       ...
       SeedFileIterator iter = 
           new SeedFileIterator(
                   new BufferedReader(new StringReader(seedFile)),
                   new BufferedWriter(ignored));
       ...
       assertTrue("didn't get naked host",
               seeds.contains("http://www.example.com/"));
       assertTrue("didn't get naked host+path",
               seeds.contains("http://www.example.org/foo"));
       assertTrue("didn't get full http URL",
