...
/**
 * Rule ACCEPTs any CrawlURIs whose path-from-seed ('hopsPath') ends 
...
public class TransclusionDecideRule extends PredicatedDecideRule {
    ...
    protected static final Integer DEFAULT_MAX_TRANS_HOPS = new Integer(3);
    ...
    public TransclusionDecideRule(String name) {
        ...
        setDescription("TransclusionDecideRule: ACCEPTs URIs whose path " +
                ...
                "configured '"+ATTR_MAX_TRANS_HOPS+"' number of transitive " +
                "hops.");
        // make default ACCEPT unchangeable 
        Type type = getElementFromDefinition(ATTR_DECISION);
        type.setTransient(true);
        addElementToDefinition(new SimpleType(ATTR_MAX_TRANS_HOPS, "Number " +
                " of non", DEFAULT_MAX_TRANS_HOPS));
    ...
    private int getThresholdHops(Object obj) {
        return ((Integer)getUncheckedAttribute(obj,ATTR_MAX_TRANS_HOPS)).intValue();
    }
}
