    ...
    <% } else { %>
        <%  if(crawling){ %>
                <tr bgcolor="#EEEEFF">
                    ...
                    <td>
                        <a href="<%=request.getContextPath()%>/reports/crawljob.jsp?job=<%=handler.getCurrentJob().getUID()%>">Crawl report</a>
                        &nbsp;
                           <a href="<%=request.getContextPath()%>/reports/seeds.jsp?job=<%=handler.getCurrentJob().getUID()%>">Seed report</a>
                           &nbsp;
                    </td>
                </tr>
        <% 
